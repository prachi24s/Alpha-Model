...
class Initialize:
    ...
    def initialize(self):
        ...
        self.camp.enableIcon('Exit_City', 'Open', 'City.BrownHouseDoor', 'Enter the Blacksmith', True)
        ...
        self.james = Character('James', 'B', 'Short_Beard', 'King', 'CastleBedroom.Bed')
        self.goldcup = Item('GoldCup', 'GoldCup', 'James')
    ...
    def talkTojames(self):
        ...
        Give(self.james, self.goldcup, self.kate)
